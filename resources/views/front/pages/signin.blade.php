        ...
        <div class="row justify-content-center">
                    ...
                    <form method="POST" action="<?= url('signin') ?>" enctype="multipart/form-data">
                        ...
                        <div class="register-form">
                            <div class="form-outline mb-3">
                                <label class="form-label" for="signin_email">Email <span class="text-danger">*</span></label>
                                <input type="email" id="signin_email" placeholder="Enter Email" class="form-control form-control-lg" name="signin_email" required>
                            </div>
                            <div class="form-outline mb-3">
                                <label class="form-label" for="signin_password">Password <span class="text-danger">*</span></label>
                                <input type="password" id="signin_password" placeholder="Enter Password" class="form-control form-control-lg" minlength="6" name="signin_password" required />
                                <span class="flex justify-around items-center"
                                    style="position: absolute; top: 43px; right: 18px;">

                                </span>
                                <span class="toggle-password" onclick="togglePassword('signin_password', this)"
                                    style="position:absolute; top:43px; right:18px; cursor:pointer;">
                                    👁
                                </span>
                            </div>
                            <div class="log-btn-reme align-items-center mt-4">
                                <button type="submit" class="btn common-btn">Login</button>
                                <a class="small f-password" href="<?= url('forgot-password') ?>" style="float:right;">Forgot password?</a>
                            </div>
                            <!-- <div class="form-outline mb-3">
            ...
            <div class="col-12 col-lg- col-xl-6 col-md-12 col-sm-12">
                <div class="register-form-field">
                    ...
                    <h6 class="alert alert-success autohide mt-3">{{ session('success_message2') }}</h6>
                    @endif
                    @if(session('error_message2'))
                    <h6 class="alert alert-danger autohide mt-3">{{ session('error_message2') }}</h6>
                    @endif
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-outline mb-3">
                                        ...
                                        <input class="form-control" placeholder="XXXXX" type="password" name="password" id="password" minlength="8" pattern="^(?=.{8,}$)(?=.*[A-Z])(?=.*\d)(?=.*[!@#$%^&*()_+\-=\[\]{};':&quot;\\|,.<>\/?]).+$" required>
                                        <span class="flex justify-around items-center" style="position: absolute; top: 37px; right: 18px;">

                                        </span>
                                        <span class="toggle-password" onclick="togglePassword('password', this)"
                                            style="position:absolute; top:37px; right:18px; cursor:pointer;">
                                            👁
                                        </span>
                                    </div>
                                </div>
