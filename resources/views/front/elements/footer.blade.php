      ...
      <div class="fotter-content">
        ...
        <div class="email-box ">
          <div class="email-area">
            <form action=""> <input type="text" class="form-control" placeholder="Enter Your Email Address" value=""></form>
            <button><img src="<?=env('FRONT_ASSETS_URL')?>images/arrow_forward.png" alt="logo"></button>
          </div>
        </div>
        <div class="submit-p">
          <form action=""> <input type="checkbox" name="" id="">
          </form>
        ...
        <div class="col-lg-4 col-sm-4">
          <div class="footer-widget">
            ...
            <ul>
              ...
              ?>
                <li><a href="<?=$footer_link[$k]?>"><?=$footer_link_name[$k]?></a></li>
              <?php } }?>
            </ul>
          </div>
        </div>
        <div class="col-lg-4 col-sm-4">
          <div class="footer-widget">
            ...
            <ul>
              ...
              ?>
                <li><a href="<?=$footer_link2[$k]?>"><?=$footer_link_name2[$k]?></a></li>
              <?php } }?>
            </ul>
          </div>
        </div>
        <div class="col-lg-4 col-sm-4">
          <div class="footer-widget">
            ...
            <ul>
              ...
              ?>
                <li><a href="<?=$footer_link3[$k]?>"><?=$footer_link_name3[$k]?></a></li>
              <?php } }?>
            </ul>
          </div>
        </div>
