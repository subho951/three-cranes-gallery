          ...
          <table class="table datatable global_table">
            <thead>
              <tr>
                ...
                <th scope="col">Type<br>Amount</th>
                <th scope="col">Start<br>End</th>
              ...
              <?php if($rows){ $sl=1; foreach($rows as $row){?>
                <tr>
                  ...
                  <td>
                    <?=$row->discount_type?>
                    <br>
                    <?php if($row->discount_type == 'FLAT'){?>
                      <span>FLAT <?=$row->discount_amount?></span>
                    <?php } else {?>
                      <span><?=$row->discount_amount?> %</span>
                    <?php }?>
                  </td>
                  <td><?=date_format(date_create($row->start_date), "M d Y")?><br><?=date_format(date_create($row->end_date), "M d Y")?></td>
